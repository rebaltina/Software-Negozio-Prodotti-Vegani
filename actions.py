...
def add_new_sale(inventory_filename, sales_filename, date): 
    ...
    if new_sale == "no":
      ...
      insert_data_in_database("vendite.json", sales)
...
def calculate_profits(sales_filename, inventory_filename):
    ...
    print(f"Il profitto netto attuale è di {gross_income-total_costs} euro")
